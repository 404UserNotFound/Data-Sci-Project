...
The below code uses Spearman Rho with datasets where the empty fields are kept and omitted with nan_policy.
"""
...
for i in years:
    ...
    coefficient, p_value = spearmanr(gdp, heart, nan_policy='omit')
